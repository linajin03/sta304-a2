...
phone_data <- phone_data %>% 
  mutate(pop_fpc = case_when(isced_level == 0 ~ 0,
                             isced_level == 1 ~ 0,
                             isced_level == 2 ~ 0,
                             isced_level == 3 ~ 8097295,
                             isced_level == 4 ~ 0,
                             isced_level == 5 ~ 5714490,
                             isced_level == 6 ~ 5295360,
                             isced_level == 7 ~ 1740605+279660)) %>%
  mutate(samp_wt = case_when(isced_level == 0 ~ 0/strata_sample_size[1],
                             isced_level == 1 ~ 0/strata_sample_size[2],
                             isced_level == 2 ~ 0/strata_sample_size[3],
                             isced_level == 3 ~ 0/strata_sample_size[4],
                             isced_level == 4 ~ 0/strata_sample_size[5],
                             isced_level == 5 ~ 0/strata_sample_size[6],
                             isced_level == 6 ~ 0/strata_sample_size[7],
                             isced_level == 7 ~ 0/strata_sample_size[8]))

strata_design <- svydesign(id=~1, strata=~isced_level, weights=~samp_wt, fpc=~pop_fpc, data=phone_data)
confint(svymean(~I(voting_choice == 'Liberal'), design=strata_design))
```
