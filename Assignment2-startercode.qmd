...
| Response                               | Corresponding ISCED Level | ISCED Level Definition                |
|----------------------------------------|---------------------------|---------------------------------------|
| No schooling                           | 0                         | Early childhood education             |
| Some elementary school                 | 1                         | Primary education                     |
| Completed elementary school            | 1                         | Primary education                     |
| Some secondary/high school             | 2                         | Lower secondary education             |
| Completed secondary/high school        | 3                         | Upper secondary education             |
| Some technical, community college      | 4                         | Post-secondary non-tertiary education |
| Completed technical, community college | 5                         | Short-cycle tertiary education        |
| Some university                        | 6                         | Bachelor or equivalent level          |
| Bachelor’s degree                      | 6                         | Bachelor or equivalent level          |
| Master’s degree                        | 7                         | Master/PhD or equivalent level        |
| Professional degree or doctorate       | 7                         | Master/PhD or equivalent level        |
...
p_liberals <- mean(phone_data$q11 == 1, na.rm = TRUE)
...
```{r, echo = FALSE}
logit_model <- glm(voting_choice ~ isced_level + age, 
                   data = phone_data, family = binomial)
