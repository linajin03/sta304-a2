...
```{r}
(exp(-2.373643))/(1-exp(-2.373643))
```

Accounting for stratification, for a person with no school on the ISCED scale (ISCED level = 0) and zero years old, the probability of them voting is around 10.27%. This is just a baseline variable, since anyone who is 0 years old cannot vote.
