...
hist(phone_data$isced_level, main = "Historgram of ISCED_Level", xlab = 'ISCED_Level', col = "brown")
...
ggplot(vote_counts, aes(x = voting_choice, y = count, fill = voting_choice)) +
  ...
  theme_minimal() + 
  scale_fill_manual(values = c("Liberal" = "blue", "Non Liberal" = "red", "Unknown" = "gray"))
```
